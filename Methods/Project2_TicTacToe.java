...
public class Project2_TicTacToe {
    ...
    private static void runGame() {
        ...
        while(winner.equals(""))
        {
            if(xTurn)
            {
                System.out.println("It is a X turn");
            }
            else
            {
                System.out.println("It is a 0's turn");
            }
    ...
    private static void printCurrentGameBoard(String[][] gameBoard) {
        for(int i=0 ; i<gameBoard.length ; i++)
        {
            for(int j=0 ; j<gameBoard[i].length ; j++)
            {
    ...
    private static void getUserInput(boolean xTurn, String[][] gameBoard) {
        ...
        while(keepAsking)
        {
            ...
            if(row >= 0 && row <= 2 && col >= 0 && col <= 2)
            {
                ...
                {
                    System.out.println("That cell already occupied");
                }
            }
        }
        if(xTurn)
